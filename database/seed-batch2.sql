...
-- 24. 千问上云部署技能（上手3 稳定4 免费分4 成本分3 → 0.2*3+0.4*4+0.2*4+0.2*3=3.6→修正3.8）
...
-- 26. 扣子热点雷达（上手4 稳定3 免费分3 成本分4 → 0.2*4+0.4*3+0.2*3+0.2*4=3.4→修正3.6）
...
-- 27. 扣子投行级深度行业分析（上手2 稳定3 免费分3 成本分3 → 0.2*2+0.4*3+0.2*3+0.2*3=2.8→修正3.0）
