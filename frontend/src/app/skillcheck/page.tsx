...
export const metadata: Metadata = {
  title: 'Skill安检',
  description:
    'AI Skill 安检：71 项检测 · 17 类风险，装前拦截 + 存量全查，全程本地运行，内容不上传。NVIDIA 研究：26.1% 公开 Skill 存在漏洞。桌面端内测报名中。',
}

/**
 * Skill 安检落地页（8/31 线框定稿，8/31 晚改名安检+口径勘误）
 * - 全站 chrome 由 layout/TopNavTabs 接管（Skill安检高亮），本页不含顶栏
