      ...
      <body className="bg-[var(--bg)] text-[var(--fg)] min-h-screen flex flex-col">
        ...
        <nav className="sticky top-0 z-50 bg-[var(--bg)] border-b border-[var(--border)]">
          ...
          <div className="page-wrapper flex items-center h-16 px-4 sm:px-6 lg:px-8 gap-4">
            <Link href="/" className="flex items-center gap-2.5 shrink-0 translate-y-[6px]">
              <img src="/logo-light.png" alt="ArcDock" className="h-[50px] w-auto dark:hidden" />
              <img src="/logo-dark.png" alt="ArcDock" className="h-[50px] w-auto hidden dark:block" />
